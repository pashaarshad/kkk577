...
class Gtpay extends PayBase
{
    const PAY_URL = 'http://gapit.gtpay66.net/Index/index';
    const PAYOUT_URL = 'http://gapit.gtpay66.net/Index/df_order';
    ...
    {
        return config('pay.gtpay.mch_id');
    }

    public function get_secret()
    {
        return config('pay.gtpay.secret');
    ...
    public function createPay(array $op_data): array
    {
        ...
        $data = [
            ...
            'store_remark' => date('Y-m-d H:i:s') ,
            'client_ip' => '127.0.0.1' ,
            'pay_type' => config('pay.gtpay.pay_type'),
    ...
    public function create_payout(array $oinfo, array $blank_info): bool
    {
        $data = [
            ...
            'money' => $oinfo['num'],
            'pay_type' => config('pay.gtpay.payout_type'),
