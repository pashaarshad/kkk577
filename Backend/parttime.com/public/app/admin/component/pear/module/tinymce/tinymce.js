layui.define(['jquery'],function (exports) {
    ...
    function initOptions(option,callback) {
        ...
        option.plugins = isset(option.plugins) ? option.plugins : 'code kityformula-editor quickbars print preview searchreplace autolink fullscreen image link media codesample table charmap hr advlist lists wordcount imagetools indent2em paste';
