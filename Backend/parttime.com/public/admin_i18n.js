...
(function (window, document) {
    ...
    var dict = [
        ...
        { zh: '轮播图设置', en: 'Poster Banners Management' },
        { zh: '轮播图管理', en: 'Poster Banners Management' },
        { zh: 'Carousel Settings', en: 'Poster Banners Management' },
        { zh: 'Banner Settings', en: 'Poster Banners Management' },
