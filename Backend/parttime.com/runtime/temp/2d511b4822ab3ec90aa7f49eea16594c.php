    ...
    function del_message(id){
         layer.confirm("确认要删除吗，删除后不能恢复",{ title: "删除确认" },function(index){
            $.ajax({
                ...
                data: {
                    'id': id,
                    '_csrf_': "<?php echo systoken('del_message'); ?>"
                },
